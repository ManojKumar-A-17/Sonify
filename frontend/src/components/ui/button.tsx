  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-primary text-white hover:scale-105 hover:shadow-glow shadow-medium",
        "gradient-outline": "border-2 border-white/50 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:scale-105",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 hover:scale-105 shadow-soft",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:scale-105 shadow-soft",
      },
      size: {
